...
@pytest.mark.parametrize("filename,expected", [
    ...
    ("IMG_3080_block_esophagus_1.jpg",
        {"role": "block", "sample_label": "esophagus_1", "stain": "",
         "is_reference": False, "image_type": "block"}),
    # --- Convention B (set-based cropped pairs with SET_METADATA) ---
    ("set_01_block_silhouette.jpeg",
        {"role": "block", "sample_label": "TWKOB5_lungs", "stain": "MT",
         "is_reference": False, "image_type": "silhouette"}),
    ("set_01_slide.jpeg",
        {"role": "slide", "sample_label": "TWKOB5_lungs", "stain": "MT",
         "is_reference": False, "image_type": "slide"}),
    ("set_02_block_barcode.jpeg",
        {"role": "block", "sample_label": "WT3_lungs", "stain": "HE",
         "is_reference": False, "image_type": "barcode"}),
    ("set_02_block_silhouette.jpeg",
        {"role": "block", "sample_label": "WT3_lungs", "stain": "HE",
         "is_reference": False, "image_type": "silhouette"}),
    ("set_02_slide.jpeg",
        {"role": "slide", "sample_label": "WT3_lungs", "stain": "HE",
         "is_reference": False, "image_type": "slide"}),
    ("set_06_block_barcode.jpeg",
        {"role": "block", "sample_label": "TWKO5_lungs", "stain": "SMA",
         "is_reference": False, "image_type": "barcode"}),
])
